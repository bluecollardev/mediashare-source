...
export class PlaylistItemsApi extends BaseAPI {
    ...
    playlistItemControllerCreate({ createPlaylistItemDto }: PlaylistItemControllerCreateRequest, opts?: OperationOpts): Observable<object | RawAjaxResponse<object>> {
    ...
    /**
     */
    playlistItemControllerFindAll({ text, tags }: PlaylistItemControllerFindAllRequest): Observable<Array<PlaylistItemDto>>
    playlistItemControllerFindAll({ text, tags }: PlaylistItemControllerFindAllRequest, opts?: OperationOpts): Observable<RawAjaxResponse<Array<PlaylistItemDto>>>
    playlistItemControllerFindAll({ text, tags }: PlaylistItemControllerFindAllRequest, opts?: OperationOpts): Observable<Array<PlaylistItemDto> | RawAjaxResponse<Array<PlaylistItemDto>>> {
    ...
    /**
     */
    playlistItemControllerFindOne({ playlistItemId }: PlaylistItemControllerFindOneRequest): Observable<PlaylistItemDto>
    playlistItemControllerFindOne({ playlistItemId }: PlaylistItemControllerFindOneRequest, opts?: OperationOpts): Observable<RawAjaxResponse<PlaylistItemDto>>
    playlistItemControllerFindOne({ playlistItemId }: PlaylistItemControllerFindOneRequest, opts?: OperationOpts): Observable<PlaylistItemDto | RawAjaxResponse<PlaylistItemDto>> {
    ...
    playlistItemControllerFindPopular(opts?: OperationOpts): Observable<RawAjaxResponse<Array<PlaylistItemDto>>>
    playlistItemControllerFindPopular(opts?: OperationOpts): Observable<Array<PlaylistItemDto> | RawAjaxResponse<Array<PlaylistItemDto>>> {
        const headers: HttpHeaders = {
            ...(this.configuration.username != null && this.configuration.password != null ? { Authorization: `Basic ${btoa(this.configuration.username + ':' + this.configuration.password)}` } : undefined),
        };
    ...
    /**
     */
    playlistItemControllerUpdate({ playlistItemId, updatePlaylistItemDto }: PlaylistItemControllerUpdateRequest): Observable<object>
    playlistItemControllerUpdate({ playlistItemId, updatePlaylistItemDto }: PlaylistItemControllerUpdateRequest, opts?: OperationOpts): Observable<RawAjaxResponse<object>>
    playlistItemControllerUpdate({ playlistItemId, updatePlaylistItemDto }: PlaylistItemControllerUpdateRequest, opts?: OperationOpts): Observable<object | RawAjaxResponse<object>> {

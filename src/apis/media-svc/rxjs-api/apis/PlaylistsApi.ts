...
export class PlaylistsApi extends BaseAPI {
    ...
    /**
     */
    playlistControllerCreate({ createPlaylistDto }: PlaylistControllerCreateRequest): Observable<PlaylistDto>
    playlistControllerCreate({ createPlaylistDto }: PlaylistControllerCreateRequest, opts?: OperationOpts): Observable<RawAjaxResponse<PlaylistDto>>
    playlistControllerCreate({ createPlaylistDto }: PlaylistControllerCreateRequest, opts?: OperationOpts): Observable<PlaylistDto | RawAjaxResponse<PlaylistDto>> {
    ...
    /**
     */
    playlistControllerFindAll({ text, tags }: PlaylistControllerFindAllRequest): Observable<Array<PlaylistDto>>
    playlistControllerFindAll({ text, tags }: PlaylistControllerFindAllRequest, opts?: OperationOpts): Observable<RawAjaxResponse<Array<PlaylistDto>>>
    playlistControllerFindAll({ text, tags }: PlaylistControllerFindAllRequest, opts?: OperationOpts): Observable<Array<PlaylistDto> | RawAjaxResponse<Array<PlaylistDto>>> {
    ...
    /**
     */
    playlistControllerFindOne({ playlistId }: PlaylistControllerFindOneRequest): Observable<PlaylistDto>
    playlistControllerFindOne({ playlistId }: PlaylistControllerFindOneRequest, opts?: OperationOpts): Observable<RawAjaxResponse<PlaylistDto>>
    playlistControllerFindOne({ playlistId }: PlaylistControllerFindOneRequest, opts?: OperationOpts): Observable<PlaylistDto | RawAjaxResponse<PlaylistDto>> {
    ...
    /**
     */
    playlistControllerShare({ playlistId, userId }: PlaylistControllerShareRequest): Observable<Array<object>>
    playlistControllerShare({ playlistId, userId }: PlaylistControllerShareRequest, opts?: OperationOpts): Observable<RawAjaxResponse<Array<object>>>
    playlistControllerShare({ playlistId, userId }: PlaylistControllerShareRequest, opts?: OperationOpts): Observable<Array<object> | RawAjaxResponse<Array<object>>> {

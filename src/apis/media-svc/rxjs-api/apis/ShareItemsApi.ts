...
export class ShareItemsApi extends BaseAPI {
    ...
    shareItemControllerFindMediaItemsSharedWithUser(opts?: OperationOpts): Observable<Array<MediaItemResponseDto> | RawAjaxResponse<Array<MediaItemResponseDto>>> {
        const headers: HttpHeaders = {
            ...(this.configuration.username != null && this.configuration.password != null ? { Authorization: `Basic ${btoa(this.configuration.username + ':' + this.configuration.password)}` } : undefined),
        };
    ...
    shareItemControllerFindShareItem({ shareId }: ShareItemControllerFindShareItemRequest, opts?: OperationOpts): Observable<ShareItem | RawAjaxResponse<ShareItem>> {
    ...
    shareItemControllerReadShareItem({ shareId }: ShareItemControllerReadShareItemRequest, opts?: OperationOpts): Observable<ShareItem | RawAjaxResponse<ShareItem>> {
    ...
    shareItemControllerRemoveShareItem({ shareId }: ShareItemControllerRemoveShareItemRequest, opts?: OperationOpts): Observable<ShareItem | RawAjaxResponse<ShareItem>> {
